...
directory = 'D:\.TUGAS AKHIR\FTP-Folder';
...
RECORD_SECONDS = 1
jarak = 0
fname1 = directory + '/soundA.wav'
fname2 = directory + '/soundB.wav'
gain = 1
...
data_size1 = wav_file1.getnframes()
print(data_size1)
data_size2 = wav_file2.getnframes()
print(data_size2)
